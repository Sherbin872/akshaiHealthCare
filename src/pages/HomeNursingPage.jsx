            ...
            <section className="relative min-h-[90vh] flex items-stretch overflow-hidden">
                ...
                <div className="relative w-full lg:w-[42%] bg-[#0A1628] flex items-center">
                    ...
                    <div className={`relative w-full px-6 sm:px-10 lg:px-12 py-16 sm:py-20 transition-all duration-800 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                        ...
                        <div className="inline-flex items-center gap-2 bg-[#DC2626]/10 border border-[#DC2626]/20 px-3 py-1.5 rounded-full mb-5">
                            ...
                            <span className="text-[#DC2626] text-[10px] font-bold uppercase tracking-widest">24/7 Nursing Available</span>
                        </div>
                        ...
                        <p className="text-white/45 text-sm leading-relaxed mb-6 max-w-sm">
                            Hospital-quality medical care delivered to your doorstep — <span className="text-white/70 font-medium">skilled nurses, compassionate hearts</span>.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-3">
                            <a href="tel:+919442659377" className={`inline-flex items-center gap-2 px-5 py-3 bg-[#DC2626] text-white font-bold text-sm rounded-xl hover:bg-[#B91C1C] transition-all duration-300 hover:scale-[1.03] shadow-lg shadow-[#DC2626]/20 ${isCallPulsing ? 'ring-4 ring-[#DC2626]/20' : ''}`}>
                ...
                <div className="hidden lg:block relative w-[58%] bg-[#0F1D4A] overflow-hidden"
                    ...
                    <div className="absolute bottom-6 right-6 bg-white/10 backdrop-blur-xl rounded-2xl px-4 py-3 border border-white/10 shadow-2xl z-20 animate-float-badge">
                        ...
                        <p className="text-white/80 text-[11px] italic">"Best home nursing care!"</p>
                        <p className="text-white/40 text-[9px] mt-0.5">— Lakshmi R.</p>
                    </div>
                    ...
                    <div className="absolute top-6 right-6 flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-3 py-1.5 border border-white/10 z-20">
                        ...
                        <span className="text-white/60 text-[10px] font-medium">Live • Nurses Available</span>
                    </div>
                </div>
