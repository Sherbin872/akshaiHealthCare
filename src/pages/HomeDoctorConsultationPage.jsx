...
const HomeDoctorConsultationPage = () => {
  ...
  const homeDoctorMainContent =
    "When you are tired of making frequent trips to hospitals, dealing with long wait times, or facing the hassle of traveling, you can consult with our doctors. Shree Akshai Healthcare enable you to access doctor consultations from the comfort of your home. The service is provided to clients who are unable to leave their homes due to any reason. We connect patients with qualified doctors in and around your region. We are committed to deliver the best and reaching out to individuals needing prompt health advice.";
