            ...
            <section className="relative min-h-[calc(100vh-56px)] pt-[56px] flex flex-col lg:flex-row overflow-hidden">
                ...
                <div className="relative w-full lg:w-[42%] bg-[#0A1628] flex items-center">
                    ...
                    <div className={`relative w-full px-6 sm:px-10 lg:px-12 py-12 sm:py-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                        <a href="#home" className="inline-flex items-center gap-2 text-white/30 hover:text-white/60 mb-6 text-xs group">
                        ...
                        <p className="text-white/60 text-sm sm:text-base mb-5 max-w-md">
                            Remote delivery of healthcare services — <span className="text-white/80 font-medium">quality medical care from the comfort of your home</span>.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <a href="tel:+919442659377" className={`flex items-center justify-center gap-2 px-5 py-3 bg-[#3B82F6] text-white font-bold text-sm rounded-xl hover:bg-[#2563EB] transition ${isCallPulsing ? 'ring-4 ring-[#3B82F6]/20' : ''}`}>
                    ...
                    <div className="hidden lg:grid grid-cols-3 grid-rows-2 gap-1 h-full p-1">
                        {heroGallery.map((img, i) => (
                            <div
                                key={i}
                                onClick={() => setActiveImage(i)}
                                className={`relative cursor-pointer overflow-hidden transition ${i === activeImage ? "col-span-2 row-span-2 ring-2 ring-[#3B82F6]/50" : "opacity-50 hover:opacity-80"}`}
                            >
                                <img
                                    src={img.src}
                                    alt={img.alt}
