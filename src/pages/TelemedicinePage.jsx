...
const TelemedicinePage = () => {
  ...
  const telemedicineIntro =
    "Akshai Healthcare Services provides the best medical care to the remote corners of the world, to the people who cannot afford the treatment due to their inability to travel, cost, unawareness etc. Telemedicine is simply defined as, 'the remote delivery of healthcare services'. Our Telemedicine platform leverages technology to connect patients with our team of experienced healthcare professionals. This virtual approach to healthcare provides a wide range of benefits, making it easier than ever to access medical consultations and advice.";
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <div className="bg-gradient-to-r from-[#1E3A8A] to-[#2563EB] rounded-2xl p-6 sm:p-8 text-white">
              <h3 className="text-xl sm:text-2xl font-bold text-center mb-6">
                Why Choose Akshai Healthcare Services' Telemedicine Services?
              </h3>
