...
const Benefits = () => {
  ...
  const benefits = [
    {
      ...
      stat: "24/7",
      image:
        "https://static.vecteezy.com/system/resources/thumbnails/015/873/894/small/24-7-hours-service-icon-in-flat-style-all-day-business-and-service-illustration-on-isolated-background-quick-service-time-sign-business-concept-vector.jpg",
    ...
    },
    {
      ...
      stat: "1:1",
      image:
        "https://www.shutterstock.com/image-photo/doctor-friend-portrait-caring-young-600nw-2575919711.jpg",
      tag: "Personalized",
    },
    {
      icon: Activity,
      ...
      stat: "Live",
      image:
        "https://static1.squarespace.com/static/5bac99efb2cf79a76d80781d/5bbc67f4085229699d754e85/5c0e03a1c2241bcfcdad86e3/1544597886879/Legal+Implications+.jpg?format=1500w",
      tag: "Digital",
    },
    {
      icon: ClipboardCheck,
      ...
      stat: "100%",
      image:
        "https://treegeyecare.com/wp-content/uploads/2024/09/depositphotos_660903092-stock-photo-indian-doctor-consoling-senior-couple.webp",
      tag: "Thorough",
    },
    {
      icon: Microscope,
      ...
      stat: "40%",
      image:
        "https://previews.123rf.com/images/stickerside/stickerside2107/stickerside210700086/172327585-40-percent-off-special-discount-offer-badge-sale-template.jpg",
      tag: "Affordable",
    },
    {
      icon: Pill,
      ...
      stat: "15%",
      image:
        "https://st.depositphotos.com/2036511/2995/v/450/depositphotos_29955585-stock-illustration-fifteen-percent-discount-button.jpg",
      tag: "Savings",
    },
  ];
  ...
  const leftTransform =
    "perspective(800px) rotateY(18deg) scale(0.88) translateX(-60px)";
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 pointer-events-none">
        ...
        >
          <path
            d="M0 20C240 5 480 35 720 18C960 0 1200 30 1440 20V0H0V20Z"
            fill="#F5F5F5"
            opacity="0.6"
          />
        </svg>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-2">
        {/* Section Header */}
        <div
          className={`text-center mb-6 lg:mb-8 transition-all duration-600 ${
        ...
        <div className="relative flex items-center justify-center h-[340px] sm:h-[360px] lg:h-[380px]">
          ...
          <div className="relative w-full flex items-center justify-center px-10 sm:px-12 overflow-hidden">
            {/* LEFT CARD */}
            <div
              className="hidden md:block absolute z-10 cursor-pointer will-change-transform"
              style={{
      ...
      <div className="absolute bottom-0 left-0 right-0 pointer-events-none">
        ...
        >
          <path
            d="M0 15C240 30 480 0 720 18C960 36 1200 5 1440 15V35H0V15Z"
            fill="#F5F5F5"
            opacity="0.7"
          />
        </svg>
...
const BenefitCardMain = ({ benefit }) => {
  return (
    <div
      className="relative w-[280px] min-[360px]:w-[300px] sm:w-[320px] lg:w-[340px] bg-white rounded-2xl shadow-xl overflow-hidden"
      style={{
    ...
    >
      <div className="relative h-36 sm:h-40 overflow-hidden">
        ...
        <div
          ...
          style={{
            background: `linear-gradient(to top, ${benefit.color}99 0%, ${benefit.color}33 40%, transparent 70%)`,
          }}
        />
        <div className="absolute top-3 left-3">
          <span
            className="text-[10px] font-bold px-2.5 py-1 rounded-full bg-white/90 backdrop-blur-sm shadow"
        ...
        <div className="absolute top-3 right-3">
          <span
            className="text-lg font-bold bg-white/90 backdrop-blur-sm rounded-lg px-2.5 py-1 shadow"
            style={{ color: benefit.color }}
          >
            {benefit.stat}
          </span>
    ...
    <div className="w-[220px] sm:w-[240px] bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
      <div className="relative h-24 overflow-hidden">
        ...
        <div
          className="absolute inset-0"
          style={{
            background: `linear-gradient(to top, ${benefit.color}88 0%, transparent 60%)`,
          }}
        />
        ...
        <div className="absolute top-2 right-2">
          <span
            className="text-sm font-bold bg-white/85 rounded-md px-1.5 py-0.5"
            style={{ color: benefit.color }}
          >
            {benefit.stat}
          </span>
