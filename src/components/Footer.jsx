...
const Footer = () => {
    ...
    const contactInfo = [
        {
            icon: MapPin,
            text: "No. 86, Bavani Complex, Iyyappan Nagar, NGO 'A' Colony, Tirunelveli - 627 007, Tamil Nadu",
        },
        {
            icon: Phone,
            text: '+91 94436 08223',
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
                    ...
                    <div className="sm:col-span-2 lg:col-span-1 animate-fade-in-up">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="w-20 h-20 sm:w-24 sm:h-24 bg-white rounded-2xl flex items-center justify-center p-2 shadow-lg flex-shrink-0">
                                <img
                                    src="/logo.png"
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <p className="text-white/50 text-xs sm:text-sm text-center sm:text-left">
                        &copy; {currentYear} Akshai Healthcare Services. All rights reserved.
                    </p>
