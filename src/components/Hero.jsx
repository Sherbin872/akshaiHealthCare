...
const Hero = () => {
  ...
  const carouselSlides = [
    {
      image:
        "https://www.jaisriohmsakthihomecare.in/wp-content/uploads/2024/09/homecare1-min-1.jpg",
    ...
    {
      image:
        "https://5.imimg.com/data5/ANDROID/Default/2021/11/LV/FC/GQ/124306331/product-jpeg-500x500.jpg",
      alt: "Doctor home visit - Expert medical consultation at your doorstep",
      tag: "Doctor Visits",
    },
    {
      image:
        "https://images.aspen.edu/wp/uploads/2022/12/GettyImages-554374209-1024x451.jpg",
      alt: "Elderly care services - Dedicated support for seniors",
      tag: "Elderly Care",
    },
    {
      image:
        "https://wellknox.com/wp-content/uploads/2022/05/physiotherapy_720.jpg",
  ...
  const nursingQuotes = [
    ...
    ' "Our nurses treat every patient like family — with dignity, compassion & respect"',
    ' "Trusted by 10,000+ families for professional home nursing services"',
    ' "Doctor-supervised nursing care — quality you can rely on 24/7"',
  ...
  return (
    <section
      id="home"
      className="relative min-h-[calc(100dvh-96px)] mt-[80px] lg:mt-[96px] flex flex-col overflow-hidden bg-gradient-to-br from-[#0B1D4A] via-[#1E3A8A] to-[#1D4ED8]"
    >
        ...
        <div className="relative bg-white/5 backdrop-blur-sm border-y border-white/10 py-2 overflow-hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 bg-gradient-to-r from-[#1E3A8A] via-[#1E3A8A]/95 to-transparent w-20 sm:w-24 z-10 flex items-center pl-3 sm:pl-4">
            <div className="flex items-center gap-1.5 bg-[#FBBF24]/20 rounded-full px-2.5 py-1">
              ...
              <span className="text-[#FBBF24] text-[10px] sm:text-xs font-bold hidden sm:inline">
                PRAISE
              </span>
            </div>
          </div>
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5 lg:py-6 flex-1 flex items-center">
        ...
        <div
          className="absolute bottom-0 left-0 w-[350px] h-[350px] bg-[#16A34A]/20 rounded-full blur-[80px] animate-blob pointer-events-none"
        ...
        <div className="relative w-full">
          {/* Top Bar: Logo + Phone */}
          <div
            className={`flex items-center justify-between mb-3 lg:mb-4 transition-all duration-700 delay-100 ${
              isVisible
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-white rounded-2xl shadow-xl flex items-center justify-center p-1.5 flex-shrink-0">
                <img
                  src="/logo.png"
              ...
              <div>
                <p className="text-white font-extrabold text-lg sm:text-xl leading-tight">
                  Akshai Healthcare Services
                </p>
                <p className="text-[#93C5FD] text-xs tracking-wide">
          ...
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-5 lg:gap-8 items-center">
            ...
            >
              ...
              <p className="text-white/70 text-sm sm:text-base leading-relaxed mb-3 lg:mb-4 max-w-lg mx-auto lg:mx-0">
                Compassionate, professional home healthcare services for your
                comfort, recovery & well-being.
              </p>
            ...
            >
              ...
              <div className="absolute -bottom-3  -right-0 bg-white rounded-xl px-3 py-2 shadow-2xl flex items-center gap-2 animate-float-badge z-30">
