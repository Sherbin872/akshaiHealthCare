...
const fullTypedText = 'Comprehensive healthcare services designed to support you at home with comfort, dignity & quality care.';
  ...
  const services = [
    {
      ...
      image:
        "https://storage.googleapis.com/apollo_blogs/uploads/Managing_Chronic_Conditions_80090c2816.png",
      features: [
    ...
    },
    {
      ...
      image:
        "https://img.freepik.com/premium-photo/indian-male-doctor-consulting-elderly-patient-medical-appointment-clinic_1166177-12158.jpg",
      features: [
    ...
    },
    {
      ...
      image:
        "https://media.istockphoto.com/id/1392760626/photo/happy-smiling-doctor-embracing-or-hugging-recovered-patient-on-wheelchair-at-hospital-park-by.jpg?s=612x612&w=0&k=20&c=5aYSBzQaQPyU-c4ia69TkSFevWuNQ0YLKh9TUaG7v8I=",
      features: [
    ...
    },
    {
      ...
      image:
        "https://img.freepik.com/free-photo/doctor-helping-patient-rehabilitation_23-2150321634.jpg?semt=ais_hybrid&w=740&q=80",
      features: [
    ...
    },
    {
      ...
      image:
        "https://images.indianexpress.com/2022/07/emergency_first-aid_1200_gettyy.jpg",
      features: ["Critical Care", "IV Therapy", "Cardiac Care", "Wound Care"],
      color: "#EA580C",
    },
    {
      icon: MonitorPlay,
      ...
      image:
        "https://cdn.expresshealthcare.in/wp-content/uploads/2020/09/22004152/EH_telemedicine_health_online_doctor_888-750x400.jpg",
      features: [
        "Remote Consult",
        "Convenience",
        "Expert Medical Team",
    ...
    {
      icon: Package,
      title: "Equipment Rentals and Sales",
      route: "/equipments",
      ...
      image:
        "https://images.pexels.com/photos/7722927/pexels-photo-7722927.jpeg?cs=srgb&dl=pexels-tara-winstead-7722927.jpg&fm=jpg",
      features: [
        "Respiratory Equipment’s",
        "Cardiac Care Equipment’s",
        "Orthopedic & Physiotherapy Equipment’s",
      ],
      color: "#4F46E5",
    },
  ];
...
useEffect(() => {
  ...
  return (
    <section
      id="services"
      className="py-16 lg:py-24 bg-[#F5F5F5] relative overflow-hidden"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <button
            onClick={() => scroll("left")}
            className={`absolute left-0 top-[45%] -translate-y-1/2 z-20 w-11 h-11 sm:w-12 sm:h-12 bg-white rounded-full shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-2xl ${
                ...
                <div className="relative bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 cursor-pointer h-full flex flex-col">
                  ...
                  <div className="relative h-40 sm:h-44 overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3 z-10">
                      <div
                        className={`w-10 h-10 sm:w-11 sm:h-11 ${service.iconBg} rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}
                      >
          ...
          <button
            ...
            className={`absolute right-0 top-[45%] -translate-y-1/2 z-20 w-11 h-11 sm:w-12 sm:h-12 bg-white rounded-full shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-2xl ${
        ...
        <div
          className={`flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mt-8 lg:mt-10 transition-all duration-700 delay-300 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          {/* Trust Badge */}
          <div className="inline-flex items-center gap-3 bg-white rounded-2xl px-5 py-3 shadow-md border border-gray-100 animate-pulse-glow">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                Doctor-supervised & verified staff
              </p>
            </div>
          </div>
