...
const CTA = () => {
    ...
    return (
       <section
  ref={sectionRef}
  className="relative min-h-screen flex items-center overflow-hidden py-10 sm:py-12 lg:py-14"
>
            {/* Background */}
                        ...
                        >
                            ...
                            <div className="relative flex items-center gap-2.5">
                                ...
                                <div className="text-left">
                                    ...
                                    <div className="text-[10px] sm:text-xs text-white/75 font-medium">+91 94436 08223</div>
                                </div>
                        ...
                        >
                            ...
                            <div className="relative flex items-center gap-2.5">
                                ...
                                <div className="flex items-center gap-3">
                                    <div className="text-left">
                                        <div className="font-extrabold">Application Form</div>
