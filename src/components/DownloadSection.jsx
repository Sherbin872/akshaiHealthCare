...
const DownloadSection = () => {
  ...
  const downloadCards = [
    {
      ...
      features: [
        {
          icon: BadgeCheck,
          text: "Complete service catalog with detailed descriptions",
        },
        {
          icon: BadgeCheck,
          text: "Plan comparison — Premium, Elite, Classic & Basic",
        },
        {
          icon: BadgeCheck,
          text: "Updated pricing: Premium ₹45K | Elite ₹35K | Classic ₹25K | Basic ₹15K",
        },
        {
          icon: BadgeCheck,
          text: "Coverage areas: Tirunelveli, Tuticorin, Tenkasi, Kanyakumari",
        },
      ],
    ...
    },
    {
      ...
      features: [
        {
          icon: BadgeCheck,
          text: "Patient condition assessment & medical history",
        },
        {
          icon: BadgeCheck,
          text: "Caregiver selection: 12hr / 24hr shifts, language preference",
        },
        {
          icon: BadgeCheck,
          text: "Service needs: Nursing, physio, diagnostics, dental & more",
        },
        {
          icon: BadgeCheck,
          text: "Instant submission — start care within 24 hours",
        },
      ],
  ...
  return (
    <section
      ref={sectionRef}
      className="py-16 lg:py-20 bg-gradient-to-b from-[#F5F5F5] to-[#FAFAFA] relative overflow-hidden"
    >
      {/* Floating Icons */}
      {floatingIcons.map((el, i) => (
        ...
        >
          <div
            ...
            style={{
              backgroundColor: el.color + "0D",
              border: `1px solid ${el.color}15`,
            }}
          >
            <el.icon
              style={{ color: el.color, opacity: 0.35 }}
      ...
      <div className="absolute top-0 left-0 right-0 pointer-events-none">
        ...
        >
          <path
            d="M0 22C300 5 600 38 900 20C1200 2 1380 30 1440 25V0H0V22Z"
            fill="#FFFFFF"
            opacity="0.7"
          />
          <path
            d="M0 25C250 10 550 35 850 22C1150 8 1350 28 1440 24V0H0V25Z"
            fill="url(#downloadWaveGrad)"
            opacity="0.4"
          />
          <defs>
            <linearGradient
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1E3A8A] mb-5 tracking-tight">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 max-w-6xl mx-auto">
          {downloadCards.map((card, index) => (
            <div
              key={index}
              className={`group relative bg-white rounded-3xl p-6 sm:p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 cursor-pointer animate-card-reveal ${
                activeCard === index ? "ring-2 scale-[1.02]" : ""
              }`}
              style={{
            ...
            >
              {/* Top Gradient Bar */}
              <div
                className={`absolute top-0 left-0 right-0 h-2 bg-gradient-to-r ${card.gradient} rounded-t-3xl`}
              />
              ...
              <a
                href={card.href}
                {...(card.href === brochure ? { download: "Akshai Healthcare Service Brochure.png" } : {})}
        ...
        {/* Bottom Trust Bar */}
        <div
          className={`text-center mt-10 lg:mt-14 transition-all duration-700 delay-300 ${
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="text-left">
                ...
                <p className="text-[10px] text-gray-400">
                  Help with forms anytime
                </p>
              </div>
            </div>
            <div className="hidden sm:block w-px h-10 bg-gray-200" />
            <a href="tel:+919443608223" className="flex items-center gap-2.5 hover:opacity-85 transition-opacity">
      ...
      <div className="absolute bottom-0 left-0 right-0 pointer-events-none">
        ...
        >
          <path
            d="M0 18C300 35 600 2 900 20C1200 38 1380 10 1440 15V40H0V18Z"
            fill="#FFFFFF"
            opacity="0.8"
          />
        </svg>
